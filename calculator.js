...
buttons_container.onclick = function (event) {
  ...
  switch (className) {
    case 'number': AddSymbolOutput(button.textContent); break;
    case 'delete': RemoveSymbolOutput(); break;
    case 'clear_all': clearAll(); break;
    case 'opposite': Opposite(); break;
    case 'dot': AddDot(); break;
    case 'plus': Operation('+'); break;
    case 'divide': Operation('/'); break;
    case 'percent': Operation('%'); break;
    case 'multiply': Operation('*'); break;
    case 'substract': Operation('-'); break;
...
document.onkeydown = function (event) {
  ...
  switch (key) {
    case 'Backspace': RemoveSymbolOutput(); break;
